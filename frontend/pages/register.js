...
import { UserPlus, Mail, Lock, AlertCircle, CheckCircle, ArrowLeft, Sparkles, Map, ShieldCheck } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-card p-8 sm:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 font-medium px-4">Join thousands of smart travelers in Manila</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <motion.div 
                ...
                className="flex items-start gap-3 p-4 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm font-bold"
              >
            ...
            {success && (
              <motion.div 
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="flex items-center gap-3 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-bold"
              >
                <CheckCircle size={18} className="shrink-0" />
                <span>Success! Taking you to login...</span>
              </motion.div>
            )}
